...
// xbart_multinomial_predict_separate_trees
...
RcppExport SEXP _XBART_xbart_multinomial_predict_separate_trees(SEXP XSEXP, SEXP y_meanSEXP, SEXP num_classSEXP, SEXP tree_pntSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type X(XSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(xbart_multinomial_predict_separate_trees(X, y_mean, num_class, tree_pnt));
    return rcpp_result_gen;
END_RCPP
}
// r_to_json
...
Rcpp::List XBART_multinomial_cpp(Rcpp::IntegerVector y, int num_class, arma::mat X, arma::mat Xtest, size_t num_trees, size_t num_sweeps, size_t max_depth, size_t n_min, size_t num_cutpoints, double alpha, double beta, double tau, double no_split_penality, Rcpp::DoubleVector weight, size_t burnin, size_t mtry, size_t p_categorical, double kap, double s, bool verbose, bool parallel, bool set_random_seed, size_t random_seed, bool sample_weights_flag, bool separate_trees, bool sample_var_per_tree, double phi_threshold);
RcppExport SEXP _XBART_XBART_multinomial_cpp(SEXP ySEXP, SEXP num_classSEXP, SEXP XSEXP, SEXP XtestSEXP, SEXP num_treesSEXP, SEXP num_sweepsSEXP, SEXP max_depthSEXP, SEXP n_minSEXP, SEXP num_cutpointsSEXP, SEXP alphaSEXP, SEXP betaSEXP, SEXP tauSEXP, SEXP no_split_penalitySEXP, SEXP weightSEXP, SEXP burninSEXP, SEXP mtrySEXP, SEXP p_categoricalSEXP, SEXP kapSEXP, SEXP sSEXP, SEXP verboseSEXP, SEXP parallelSEXP, SEXP set_random_seedSEXP, SEXP random_seedSEXP, SEXP sample_weights_flagSEXP, SEXP separate_treesSEXP, SEXP sample_var_per_treeSEXP, SEXP phi_thresholdSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< size_t >::type random_seed(random_seedSEXP);
    Rcpp::traits::input_parameter< bool >::type sample_weights_flag(sample_weights_flagSEXP);
    Rcpp::traits::input_parameter< bool >::type separate_trees(separate_treesSEXP);
    Rcpp::traits::input_parameter< bool >::type sample_var_per_tree(sample_var_per_treeSEXP);
    Rcpp::traits::input_parameter< double >::type phi_threshold(phi_thresholdSEXP);
    rcpp_result_gen = Rcpp::wrap(XBART_multinomial_cpp(y, num_class, X, Xtest, num_trees, num_sweeps, max_depth, n_min, num_cutpoints, alpha, beta, tau, no_split_penality, weight, burnin, mtry, p_categorical, kap, s, verbose, parallel, set_random_seed, random_seed, sample_weights_flag, separate_trees, sample_var_per_tree, phi_threshold));
    return rcpp_result_gen;
END_RCPP
}
// XBART_Probit_cpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_XBART_xbart_multinomial_predict_separate_trees", (DL_FUNC) &_XBART_xbart_multinomial_predict_separate_trees, 4},
    ...
    {"_XBART_XBART_multinomial_cpp", (DL_FUNC) &_XBART_XBART_multinomial_cpp, 27},
